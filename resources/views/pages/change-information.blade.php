      ...
      <div class="col-md-6 col-md-offset-3">
         <div class="panel panel-default" style="margin: 65px 0px;">
            ...
            <div class="panel-body">
               <form action="{{route('changeInformation')}}" method="POST">
                  <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                  <div class="input-group">
                     <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                     <input type="text" class="form-control" name="name" placeholder="Họ tên" value="{{Auth::user()->name}}" required />
                  </div>
                  <br/>
                  <div class="input-group">
                     <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                     <input type="text" class="form-control" name="phonenumber" placeholder="Số điện thoại" value="{{Auth::user()->phone_number}}" required />
                  </div>
                  <br/>
                  <div class="input-group">
                     <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                     <input type="text" class="form-control" name="address" placeholder="Địa chỉ" value="{{Auth::user()->address}}" required />
                  </div>
                  <br/>
